...
public class MouseLook : MonoBehaviour {
	...
	void Update () {
		...
		//transform.Rotate (mouseY, mouseX, 0f);//up/down only rotates Camera 
		...
		// correction pass: un-roll the camera? manually override Z eulerAngle to 0 degrees
		transform.localEulerAngles = new Vector3 (
			verticalLook,//override X degrees with our own verticalLook value 
			transform.localEulerAngles.y,// put y degree back into itself 
